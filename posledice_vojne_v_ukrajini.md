...
<div style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); color: #ffffff; padding: 22px 26px; border-radius: 10px; margin-bottom: 28px; box-shadow: 0 4px 15px rgba(0,0,0,0.15);">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-top: 14px;">
    <div style="background: rgba(255,255,255,0.12); padding: 12px 16px; border-radius: 8px; border-left: 4px solid #ffd700;">
      <div style="font-size: 1.7em; font-weight: bold; color: #ffd700;">> 6,5 mio</div>
      <div style="font-size: 0.9em; opacity: 0.95;">Ukrajinskih beguncev z začasno zaščito v EU in po svetu (90 % ženske in otroci)</div>
    </div>
    <div style="background: rgba(255,255,255,0.12); padding: 12px 16px; border-radius: 8px; border-left: 4px solid #00d2ff;">
      <div style="font-size: 1.7em; font-weight: bold; color: #00d2ff;">> 3,7 mio</div>
      <div style="font-size: 0.9em; opacity: 0.95;">Notranje razseljenih oseb (IDP), ki so izgubile svoje domove</div>
    </div>
    <div style="background: rgba(255,255,255,0.12); padding: 12px 16px; border-radius: 8px; border-left: 4px solid #ff6b6b;">
      <div style="font-size: 1.7em; font-weight: bold; color: #ff6b6b;">> 10 mest</div>
      <div style="font-size: 0.9em; opacity: 0.95;">Popolnoma izbrisanih z obličja zemlje (Mariupol, Bahmut, Marjinka, Avdijivka ...)</div>
    </div>
    <div style="background: rgba(255,255,255,0.12); padding: 12px 16px; border-radius: 8px; border-left: 4px solid #e056fd;">
