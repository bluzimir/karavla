...
<div style="background: linear-gradient(135deg, #1e3c72 0%, #2a5298 100%); color: #ffffff; padding: 22px 26px; border-radius: 10px; margin-bottom: 28px; box-shadow: 0 4px 15px rgba(0,0,0,0.15);">
  ...
  <p style="margin-bottom: 0; line-height: 1.6; font-size: 1.05em;">
...
<div style="background: #f8f9fa; border: 1px solid #e9ecef; border-left: 5px solid #2a5298; padding: 18px 22px; border-radius: 8px; margin: 20px 0;">
